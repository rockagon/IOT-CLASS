...
const baseUrl = 'http://localhost:8000/pi/actuators';
...
router.route('/').get(function (req, res, next) {
    if (req.accepts('html')) {
        res.send('<html><body><h1>Actuators</h1><p><a href="/pi/actuators/ledldr">LDR Light</a></p><p><a href="/pi/actuators/ledpir">PIR Light</a></p></body></html>');
    } else {
        res.send({
